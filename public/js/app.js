...
__webpack_require__(/*! ./components/urlMetaScraper.js */ "./resources/js/components/urlMetaScraper.js");
...
/***/ "./resources/js/components/tagList.js":
/*!********************************************!*\
  !*** ./resources/js/components/tagList.js ***!
  \********************************************/
/***/ (() => {
...
window.tagList = function (tags, allTags) {
  return {
    tags: tags,
    all_tags: allTags,
    toggleTag: function toggleTag(tagToToggle) {
      var tagToToggleSimple = simpleSearchStr(tagToToggle);
      var oldTagArr = this.tags.split(',');
      var newTagArr = [];
      var foundTag = false;

      while (oldTagArr.length) {
        var oldTag = oldTagArr.shift();
        var oldTagSimple = simpleSearchStr(oldTag);
...
/***/ "./resources/js/components/urlMetaScraper.js":
/*!***************************************************!*\
  !*** ./resources/js/components/urlMetaScraper.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
window.urlMetaScraper = function (url, title, description) {
  return {
    ...
    fetchUrlMetadata: function fetchUrlMetadata() {
      var _this = this;
      ...
      axios.post('/api/get_url_metadata', {
        ...
        _this.title = _.get(response, 'data.title');
        _this.description = _.get(response, 'data.description');
...
window.simpleSearchStr = function (str) {
  if (!str || typeof str !== 'string') return str; // Replace all diacritics (see above)

  return str.normalize('NFD').replace(/[\u0300-\u036f\(\)\[\]\<\>\"\"]/g, '').replace('œ', 'oe') // Remove any funny/curly quotes
  .replace(/[\u2018\u2019]/g, "'").replace(/[\u201C\u201D]/g, '"') // Replace any hyphens/dashes with spaces
  .replace(/[\u2014\-]/g, ' ') // Remove any duplicate whitespace
    ...
    switch (error.response.status) {
      ...
      case 422:
        if (error.response.data.errors) {
          _.forOwn(error.response.data.errors, function (errItem, key) {
            if (Array.isArray(errItem)) {
              errItem.forEach(function (errMsg) {
